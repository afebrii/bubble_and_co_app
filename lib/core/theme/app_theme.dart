...
class AppThemeColors {
  ...
  static const Color primary = Color(0xFF2A7FBF); // Main blue from logo
  static const Color primaryLight = Color(0xFF5CA3D6);
  static const Color primaryDark = Color(0xFF1D5C8A);
  static const Color primarySurface = Color(0xFFE6F2FA);

  // Secondary Colors
  static const Color secondary = Color(0xFF80BCE8);
  static const Color secondaryLight = Color(0xFFEAF5FD);
  ...
  static const LinearGradient primaryGradient = LinearGradient(
    ...
    colors: [Color(0xFF5CA3D6), Color(0xFF2A7FBF)],
  );
